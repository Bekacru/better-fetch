...
export const createFetchWithDefault = <Res, Err = unknown>() => {
	const $fetchClosure = <Option extends CreateFetchOption>(
		config?: Option,
	): BetterFetch<Option, Res, Err> => {
		return (async (url: string, options?: BetterFetchOption) => {
