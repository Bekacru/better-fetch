export function GithubStat({ stars }: { stars: string | null }) {
	return (
		...
		>
			<span className="absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 ease-out translate-x-12 rotate-12 dark:bg-white/60 bg-black/60 opacity-10 group-hover:-translate-x-40"></span>
			...
			<div className="flex items-center gap-1 ml-2 text-sm md:flex">
				<svg
				...
				<span className="inline-block font-medium tracking-wider text-black tabular-nums font-display dark:text-white">
					{stars}
				</span>
			</div>
		</a>
