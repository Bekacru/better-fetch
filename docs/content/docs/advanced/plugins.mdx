...
Plugins are functions that can be used to modify the request, response, error and other parts of the request lifecycle and can be used to define <Link href="/docs/advanced/fetch-schema">Fetch Schema</Link>.
