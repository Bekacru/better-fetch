...
*You also need to hav [zod](https://www.npmjs.com/package/zod) installed for schema validations. If you don't plan to use zod schema validation, you can install it as a dev dependency.*
